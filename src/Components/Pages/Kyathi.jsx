...
import './Kyathi.css'; // Import your CSS file for styling
...
const Kyathi = () => {
  ...
  const handleSellClick = () => {
    ...
    navigate('/sell', { state: { potatoName: 'Kyathi' } });
  };

  return (
    <div className="potato-detail-container">
      <h1>Potato Variant: Kyathi</h1>
      <img src="../../assets/3.jpg" alt="Potato Kyathi" className="potato-image" />
