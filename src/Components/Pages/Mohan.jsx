...
import './Mohan.css'; // Import your CSS file for styling
...
const Mohan = () => {
  ...
  const handleSellClick = () => {
    ...
    navigate('/sell', { state: { potatoName: 'Mohan' } });
  };

  return (
    <div className="potato-detail-container">
      <h1>Potato Variant: Mohan</h1>
      <img src="../../assets/3.jpg" alt="Potato Mohan" className="potato-image" />
