...
import './Jyothi.css'; // Import your CSS file for styling
...
const Jyothi = () => {
  ...
  const handleSellClick = () => {
    ...
    navigate('/sell', { state: { potatoName: 'Jyothi' } });
  };

  return (
    <div className="potato-detail-container">
      <h1>Potato Variant: Jyothi</h1>
      <img src="../../assets/3.jpg" alt="Potato Jyothi" className="potato-image" />
